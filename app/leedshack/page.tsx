    ...
    return (
        ...
        <main className="flex-grow flex flex-col items-left space-y-6 p-4 md:p-24 bg-primary text-white">
            ...
            <p className="text-2xl text-left font-barlow">
                We&apos;re excited to announce that on February 8-9th, we will be hosting LeedsHack 2025!
            </p>
            <h2 className="text-4xl font-bold text-left mt-4">What is LeedsHack?</h2>
            <p className="text-2xl text-left font-barlow">
                LeedsHack is a 24-hour hackathon where students from across the UK will come together to innovate, collaborate, and create solutions in the fields of computer science and software engineering.
