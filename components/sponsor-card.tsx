        ...
        <div className="bg-white rounded-lg shadow-lg p-4 flex flex-col sponsor-card">
            {type === "sunflower" && (
                <div className="text-black p-2 rounded-lg flex items-center justify-center mb-4">
                    <Image src="/images/leedshack/sunflower.png" alt="Sunflower" className="object-cover rounded-lg" height={67} width={67} />
                    <h2 className="text-2xl font-bold ml-2">Sunflower sponsor</h2>
                </div>
            )}
            {type === "sprout" && (
                <div className="text-black p-2 rounded-lg flex items-center justify-center mb-4">
                    <Image src="/images/leedshack/sprout.png" alt="Sprout" className="object-cover rounded-lg" height={67} width={67} />
                    <h2 className="text-2xl font-bold ml-2">Sprout sponsor</h2>
                </div>
            )}
            {type === "seed" && (
                <div className="text-black p-2 rounded-lg flex items-center justify-center mb-4">
                    <Image src="/images/leedshack/seed.png" alt="Seed" className="object-cover rounded-lg" height={67} width={67} />
